...
<solution name="org.modelix.modelcheck.mps.plugin" uuid="306183fb-952a-4095-9ca0-a4b846e2036e" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    ...
    <stubModelEntry path="${module}/lib/mps-integration.jar" />
    <stubModelEntry path="${module}/lib/kotlinx-html-jvm.jar" />
